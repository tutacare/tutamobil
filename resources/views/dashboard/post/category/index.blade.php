...
{!! Html::script("/mytuta/js/category.js") !!}
...
@section('content-header-small', 'Berita')
@section('breadcump')
<li>Dashboard</li>
<li>Berita</li>
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
<button class="btn btn-success" id="btn-add"><i class="fa fa-plus-circle"></i> Tambah Kategori</button> <button class="btn btn-info" id="btn-refresh"><i class="fa fa-refresh"></i></button>
    </h3>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
