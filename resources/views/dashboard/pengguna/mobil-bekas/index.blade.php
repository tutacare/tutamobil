...
<div class="box">
	...
	<div class="box-body">
		<table id="cdata" class="table table-bordered table-striped">
          ...
          <td>
			            {!! Form::open(['route' => ['dashboard.pengguna.mobil-bekas.destroy', $value->id], 'method' => 'delete']) !!}
                  <a href="{!! route('dashboard.pengguna.mobil-bekas.show', $value->id) !!}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-eye-open"></i></a>
			            <a href="{!! route('dashboard.pengguna.mobil-bekas.edit', $value->id) !!}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
