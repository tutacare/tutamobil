...
{!! Html::script("/mytuta/js/merek.js") !!}
...
$('#btn-refresh').click(function(){
  ...
  $('#menu-merek').addClass("active");

});
</script>
@endsection

@section('content-header', 'Merek')
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">
<button class="btn btn-success" id="btn-add"><i class="fa fa-plus-circle"></i> Tambah Merek</button> <button class="btn btn-info" id="btn-refresh"><i class="fa fa-refresh"></i></button>
    </h3>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
		<table id="example" class="table table-bordered table-striped">
			...
			<tbody id="merek-list" name="merek-list">
        @foreach($merek as $value)
            <tr id="merek{{ $value->id }}">
                <td>{{ $value->merek }}</td>
                <td>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Merek Form</h4>
          </div>
          <div class="modal-body">
          {!! Form::open(array('id' => 'frm', 'name' => 'frm',  'onsubmit' => "return false;")) !!}
          <input id="token" type="hidden" value="{{$encrypted_token}}">
          @include('dashboard.merek._form')
          {!! Form::close() !!}
          </div>
